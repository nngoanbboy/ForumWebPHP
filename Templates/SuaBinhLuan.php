<?php
	if (isset($_POST['form']) && $_POST['form'] == 'submitted') {
		...
		$binhLuanController->SuaBinhLuan(); 
	}
			...
			<form method="post">
				...
				<div class="card">
					<div class="card-header pb-0 bg-dark text-light">
						<h5 class="card-title mb-0">Sửa bình luận</h5>
					</div>
					<div class="card-body">
						...
						<div>
							<textarea type="text" style="height: 500px;" class="col-xl-12 form-control form-control-lg" id="noiDung" name="noiDung" required placeholder="Nội dung bình luận"></textarea>
						</div>
					</div>
